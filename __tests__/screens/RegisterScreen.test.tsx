...
describe('RegisterScreen', () => {
  ...
  it('should handle input changes correctly', () => {
    ...
    fireEvent.changeText(emailInput, 'paras@gmail.com');
    fireEvent.changeText(passwordInput, 'password123');
    fireEvent.changeText(firstNameInput, 'Paras');
    fireEvent.changeText(lastNameInput, 'Sahu');

    expect(emailInput.props.value).toBe('paras@gmail.com');
    expect(passwordInput.props.value).toBe('password123');
    expect(firstNameInput.props.value).toBe('Paras');
    expect(lastNameInput.props.value).toBe('Sahu');
  });
  ...
  it('should call registeruser and navigate on successful register', async () => {
    ...
    fireEvent.changeText(getByPlaceholderText('Email'), 'paras@gmail.com');
    fireEvent.changeText(getByPlaceholderText('Password'), 'password123');
    fireEvent.changeText(getByPlaceholderText('First name'), 'Paras');
    fireEvent.changeText(getByPlaceholderText('Last name'), 'Sahu');
    fireEvent.press(getByTestId('Register'));
  });
